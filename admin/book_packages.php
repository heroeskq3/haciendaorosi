...
<?php
if ($form_add) {
    class_bookPackagesAdd($Id, $Name, $Price, $IV, $IS, $VigenciaDel, $VigenciaAl, $SectorId, $Status);
...
$formFields = array(
    ...
    'Price'       => array('inputType' => 'text', 'required' => false, 'position' => 1, 'name' => 'Price', 'value' => $Details),
    'IV'          => array('inputType' => 'select', 'required' => true, 'position' => 1, 'name' => 'IV', 'value' => $array_rowsperpage),
    'IS'          => array('inputType' => 'select', 'required' => true, 'position' => 1, 'name' => 'IS', 'value' => $array_rowsperpage),
    'VigenciaDel' => array('inputType' => 'date', 'required' => true, 'position' => 1, 'name' => 'VigenciaDel', 'value' => $VigenciaDel),
    'VigenciaAl'  => array('inputType' => 'date', 'required' => true, 'position' => 1, 'name' => 'VigenciaAl', 'value' => $VigenciaAl),
