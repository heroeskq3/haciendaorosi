...
function class_surveyRegister()
{
    ...
    $formFields = array(
        ...
        'Apellidos'                       => array('inputType' => 'text', 'required' => false, 'position' => 1, 'name' => 'LastName', 'value' => isset($LastName)),
        'Nombre de identificación'        => array('inputType' => 'text', 'required' => false, 'position' => 1, 'name' => 'Identification', 'value' => isset($Identification)),
        ...
        'Nombre de la empresa'            => array('inputType' => 'text', 'required' => false, 'position' => 1, 'name' => 'Company', 'value' => isset($Company)),
        'Puesto en la empresa'            => array('inputType' => 'select', 'required' => false, 'position' => 1, 'name' => 'Position', 'value' => $array_Position),
